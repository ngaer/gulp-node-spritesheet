# gulp-node-spritesheet [![Build Status](https://secure.travis-ci.org/ngaer/gulp-node-spritesheet.png?branch=master)](http://travis-ci.org/ngaer/gulp-node-spritesheet)
